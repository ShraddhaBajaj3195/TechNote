		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-6 md_6">
					<img class="side_image" src="images/a.jpg" ></img>
				</div>
				<div class="col-md-6 login_form_div md_6">
					...
					<form method="post" class="form-horizontal" action="login_submit.php"> 
						<h2 class="heading_login"><u>SignIn</u></h2>
						<?php if(isset($_SESSION['login_error_msg'])) {  ?>
							<h6 class="login_error_msg"><?php echo $_SESSION['login_error_msg']; $_SESSION['login_error_msg']=''; ?></h6>	
						<?php }?>
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-md-6  col-9 form-group">
									<input value="Submit"  type="submit" class="form-control submit_button">
							</div>
						</div>
						<div class="btn_register_div">
							For New User : <a href="register.php" class="btn_register">SignUp</a>
						</div>
					</form>
					
					<div class="col-md-6 heading_footer">
							Designed By Shraddha Bajaj</a>
					</div>
                </div>
				</div>
